...
// Provider stack for page-content islands (below the global header). Route +
// GlobalStatic + Theme + Viewer[isPreview] + Community + i18n. Page content
...
// kept out entirely here; the per-viewer header/footer UI (account nav, footer
// admin/sign-in) renders via `server:defer` islands instead. Content consumers of
